    ...
    <container>
        <div class="main-contentner ">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-6">
                ...
                <?php
                         if(isset($_GET['phimle_id'])):
                        $phimle_id = $_GET['phimle_id'];
                        $getMoveByPhimLeId = $move->getMoveByPhimLeId($phimle_id);
                            ...
                            <div class="list--theater-moive  col-xs-6 col-md-8 col-sm-6" style="margin-top: 3%;">
                                ...
                                <?php  
                                    ...
                                    $page = isset($_GET['page']) ? $_GET['page']:1;
                                     $total = count($getMoveByPhimLeId);
                                     $url = $_SERVER['PHP_SELF']."?phimle_id=".$phimle_id;
                                     $getMoveByPhimLeId = $move->phimLeMoviePaging($phimle_id,$page,$perPage); 
                                                        
                                foreach($getMoveByPhimLeId as $value):  
                                ?>
