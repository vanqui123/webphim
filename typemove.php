        ...
        <div class="main-contentner ">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-6">
                ...
                <?php
                        ...
                        $getMoveByTypeId = $move->getMoveByTypeId($type_id);
                            ...
                            <div class="list--theater-moive  col-xs-6 col-md-8 col-sm-6" style="margin-top: 3%;">
                                ...
                                <?php  
                                    ...
                                    $page = isset($_GET['page']) ? $_GET['page']:1;
                                     $total = count($getMoveByTypeId);
                                     $url = $_SERVER['PHP_SELF']."?type_id=".$type_id;
                                     $getMoveByTypeId = $move->typeMoviePaging($type_id,$page,$perPage); 
                                             
                                foreach($getMoveByTypeId as $value):  
                                ?>
