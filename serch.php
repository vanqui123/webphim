                        ...
                        <div class="list--phimbochieurap-movie" style="margin-top: 74px;">
                            ...
                            <div class="list--theater-moive  col-xs-6 col-md-8 col-sm-6" style="margin-top: 3%;">
                                <div class="title--theater-movie">
                                    <span>KẾT QUẢ TÌM KIẾM CHO PHIM <?php echo $keyword ?> </span>
                                </div>
                                ...
                                <?php  
                                    ...
                                    $page = isset($_GET['page']) ? $_GET['page']:1;
                                     ...
                                     $search = $move->searchPaging($keyword,$page,$perPage); 
                                                        
                                if(count($search)==0){
                                    echo "<h2 style='color:#ffff'> Không tìm thấy Phim</h2>";}
                                else
