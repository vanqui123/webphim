    ...
    <container>
        <div class="main-contentner ">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-6">
                ...
                <?php
                         if(isset($_GET['phimbo_id'])):
                        $phimbo_id = $_GET['phimbo_id'];
                        $getMoveByPhimBoId = $move->getMoveByPhimBoId($phimbo_id);
                            ...
                            <div class="list--theater-moive  col-xs-6 col-md-8 col-sm-6" style="margin-top: 3%;">
                                ...
                                <?php  
                                    ...
                                    $page = isset($_GET['page']) ? $_GET['page']:1;
                                     $total = count($getMoveByPhimBoId);
                                     $url = $_SERVER['PHP_SELF']."?phimbo_id=".$phimbo_id;
                                     $getMoveByPhimBoId = $move->phimBoMoviePaging($phimbo_id,$page,$perPage); 
                                                        
                                foreach($getMoveByPhimBoId as $value):  
                                ?>
